...
const initProjects = [
  ...
  {
    id: 2,
    name: 'Medical Referral eSignature Integration',
    description: 'Designed embedded app for Welkin user to retrieve Docusign hosted contacts and forms, add patient info, send for signature, and receive signature status updates without leaving Welkin app.',
